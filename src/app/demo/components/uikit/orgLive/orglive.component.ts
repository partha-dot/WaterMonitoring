   ...
   ggg(){
    ...
    ngOnInit() {
        ...
        this.route.paramMap.subscribe((params) => {
            ...
            this.getDevice1(+this.organizationName);
...
//let wind_direction = getWindDirection(wind_direction_val);
   // console.log(wind_direction);  // Output: "NE"
    ...
    // }
    connectToWebSocket(org_id) {
        // this.websocketService.devsocketClose();

        this.spinner=true;
        this.websocketSubscription = this.websocketService.connectOrg(this.client_id,org_id)
          .subscribe(
            (message) => {
              console.log('Received message:', message);
              const jsonString = message
